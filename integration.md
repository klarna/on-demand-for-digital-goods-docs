...
```html
<form action="/subscription" method="POST" class="klarna-form" data-api-key="test_d4ca9ed6-489b-42b3-8011-dacdcee0fdb6" data-flow="recurring-purchase" data-locale="sv">
  <input type="hidden" name="article_id" value="1">
</form>
```
